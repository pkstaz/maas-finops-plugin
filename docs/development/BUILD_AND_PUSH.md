...
| `FRONTEND_IMAGE` | Frontend image name | `maas-finops` |
| `BFF_IMAGE` | BFF image name | `maas-finops-bff` |
| `CHART_NAME` | Helm chart name | `maas-finops-chart` |
...
- **Registry**: `quay.io`
- **Frontend image**: `quay.io/rh-ai-community-plugins/maas-finops`
- **BFF image**: `quay.io/rh-ai-community-plugins/maas-finops-bff`
...
podman build -t quay.io/rh-ai-community-plugins/maas-finops:0.5.0 -f Containerfile .
podman push quay.io/rh-ai-community-plugins/maas-finops:0.5.0

podman build -t quay.io/rh-ai-community-plugins/maas-finops-bff:0.5.0 -f bff/Containerfile bff/
podman push quay.io/rh-ai-community-plugins/maas-finops-bff:0.5.0
```
...
- **Chart name**: `maas-finops-chart`
- **OCI registry**: `oci://quay.io/rh-ai-community-plugins/maas-finops-chart`
...
This produces a `maas-finops-chart-<version>.tgz` file in the current directory, using the version from `chart/Chart.yaml`.
...
helm push maas-finops-chart-<version>.tgz oci://quay.io/rh-ai-community-plugins
```
